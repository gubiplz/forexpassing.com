...
// Nowy zestaw kanałów. Archiwum STARYCH (porzuconych po zamrożeniu konta)
// leży już w `archive/` i jest materiałem do odtworzenia treści.
const DOMYSLNE = ['forex_passing', 'forex_passing_payouts',
                  'forex_passing_track_record'];
